...
export default (sequelize, DataTypes) => {
  ...
  passwordreset.associate = function (models) {
     ...
     * Guess passwordreset has a collection of cookies table.
     * At the same time, cookies just saves one reference 
     * (foreign key) to it's passwordreset's
     * 
     *   models.passwordreset.hasMany(models.cookie, {
     ...
     *   })
     * 
     * At cookie.model.js must be declared the reference to it's passwordreset owner 
     * on associate function as follow:
     * 
     *   models.cookie.belongsTo(models.passwordreset, {
